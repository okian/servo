...
implementation below — it's what will let [chapter 14](14-testing-strategy.md) swap in a mock
...
[chapter 18](18-alternatives-and-further-reading.md#migrations) for when to make that switch.)
