...
implementation below — it's what will let [chapter 18](18-testing-strategy.md) swap in a mock
...
names `Init`, `Stop`, and `Health` for a moment: [chapter 14](14-wiring-with-servo.md) is where
...
[chapter 22](22-alternatives-and-further-reading.md#migrations) for when to make that switch.)
