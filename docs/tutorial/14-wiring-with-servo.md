...
entries come from chapters you haven't reached yet — `observability` (chapter 16), `resilience`
(chapter 17), and the `session` scope at the bottom (chapter 15). Generate it yourself at this
...
[Chapter 15: Scoped instances](15-scoped-instances.md) — the one thing in this graph that shouldn't
