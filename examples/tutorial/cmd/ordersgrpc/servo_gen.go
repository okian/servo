...
//	[L2] *example.com/servoorders/grpcapi.Config
//	      deps: *example.com/servoorders/config.Env
//	      capabilities: none | binding: sole candidate | grpcapi/server.go:50:6
...
//	[L6] *example.com/servoorders/grpcapi.Server
//	      deps: *example.com/servoorders/grpcapi.Config, *example.com/servoorders/service.OrderService, *example.com/servoorders/service.AuthService, *example.com/servoorders/auth.Issuer, *example.com/servoorders/observability.Metrics, *example.com/servoorders/observability.Tracer, *example.com/servoorders/resilience.RateLimiter, example.com/servoorders/session.Sessions, *example.com/servoorders/observability.Logger
//	      capabilities: Runner, Finalizer | binding: sole candidate | grpcapi/server.go:54:6
...
func (a *App) stopServer(ctx context.Context) servo.NodeResult {
	a.serverStopOnce.Do(func() {
		var results []servo.NodeResult
		results = append(results, servo.RunStop(ctx, servo.DefaultStopBudget, "*example.com/servoorders/grpcapi.Server", a.server.Stop))
		a.serverStopResult = servo.MergeNodeResults("*example.com/servoorders/grpcapi.Server", results...)
	})
...
func (a *App) Graph() servo.Graph {
	return servo.Graph{Nodes: []servo.GraphNode{
		...
		{Type: "*example.com/servoorders/grpcapi.Config", Level: 2, Deps: []string{"*example.com/servoorders/config.Env"}, Capabilities: nil, Binding: "sole candidate", Pos: "grpcapi/server.go:50:6"},
		...
		{Type: "*example.com/servoorders/grpcapi.Server", Level: 6, Deps: []string{"*example.com/servoorders/grpcapi.Config", "*example.com/servoorders/service.OrderService", "*example.com/servoorders/service.AuthService", "*example.com/servoorders/auth.Issuer", "*example.com/servoorders/observability.Metrics", "*example.com/servoorders/observability.Tracer", "*example.com/servoorders/resilience.RateLimiter", "example.com/servoorders/session.Sessions", "*example.com/servoorders/observability.Logger"}, Capabilities: []string{"Runner", "Finalizer"}, Binding: "sole candidate", Pos: "grpcapi/server.go:54:6"},
