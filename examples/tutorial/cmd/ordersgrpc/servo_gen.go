...
//	[L0] example.com/servoorders/internal/transport/grpcapi.Config
//	      servo:config (prefix HTTP)  internal/transport/grpcapi/server.go:50:6
...
//	[L4] *example.com/servoorders/internal/transport/grpcapi.Server
...
//	      capabilities: Runner, Finalizer, Readier | binding: sole candidate | internal/transport/grpcapi/server.go:55:6
//
...
func New(ctx context.Context) (*App, error) {
	...
	grpcapiConfig, err := grpcapi.ServoConfig()
	if err != nil {
		return nil, err
	}
...
func (a *App) Graph() servo.Graph {
	return servo.Graph{Nodes: []servo.GraphNode{
		...
		{Type: "example.com/servoorders/internal/transport/grpcapi.Config", Level: 0, Deps: nil, Capabilities: nil, Binding: "config directive", Pos: "internal/transport/grpcapi/server.go:50:6"},
		...
		{Type: "*example.com/servoorders/internal/transport/grpcapi.Server", Level: 4, Deps: []string{"example.com/servoorders/internal/transport/grpcapi.Config", "*example.com/servoorders/internal/service.OrderService", "*example.com/servoorders/internal/service.AuthService", "*example.com/servoorders/internal/auth.Issuer", "*example.com/servoorders/internal/observability.Metrics", "*example.com/servoorders/internal/observability.Tracer", "*example.com/servoorders/internal/resilience.RateLimiter", "example.com/servoorders/internal/session.Sessions", "*example.com/servoorders/internal/observability.Logger"}, Capabilities: []string{"Runner", "Finalizer", "Readier"}, Binding: "sole candidate", Pos: "internal/transport/grpcapi/server.go:55:6"},
